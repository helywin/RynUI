...
RUNTIME_GLOBALS = {
    ...
    "motionEaseInOutCirc", "motionEaseOut", "motionEaseInOut",
    "motionEaseOutBack", "motionEaseInBack", "motionEaseInQuint",
    "motionEaseOutQuint", "motion", "wireframe",
    ...
    "colorPrimaryBorder", "colorErrorHover", "colorErrorActive", "colorErrorOutline",
    "controlOutline", "controlTmpOutline",
