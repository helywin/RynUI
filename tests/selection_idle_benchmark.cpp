...
int main() {
    try {
        ...
        if (fixture.services.next_frame_deadline())
            throw std::runtime_error("idle selection window scheduled a frame");
        ...
        const auto material_updates = fixture.services.surfaces().diagnostics().material_updates;
        ...
        for (std::size_t index = 0; index < iterations; ++index) {
            if (fixture.services.next_frame_deadline()
                ...
                throw std::runtime_error("idle selection window did animation work");
            }
        }
        ...
        if (fixture.services.components().mount_runs() != mounts
            ...
            || fixture.services.surfaces().diagnostics().material_updates != material_updates) {
            throw std::runtime_error("idle selection window updated retained content");
        }
