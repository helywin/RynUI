...
lifecycle_active=0
allocation_count=0
button_journey=headless deferred/owner-destroy plus real-window enter/down/up/leave/Tab/Enter/loading/Theme-motion/reduced journey
automated_input_events=7
pointer_input_events=4
hover_enters=1
hover_leaves=1
captures_started=1
captures_released=1
